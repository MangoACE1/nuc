...
def complete_config_mapping() -> dict[str, object]:
    return {
        ...
        "release_mode": "armed_auto",
        "release_buffer_s": 0.25,
        "release_fit_window_s": 0.05,
        "release_min_pose_samples": 8,
        "release_min_twist_samples": 8,
        "release_min_speed_mps": 0.35,
        "release_max_position_rms_m": 0.012,
        "release_max_velocity_rms_mps": 0.20,
        "release_max_acceleration_error_mps2": 4.0,
        "release_confirmation_windows": 2,
        "active_tracking_budget_s": 5.0,
        "gravity_mps2": 9.81,
        "drag_beta_m_inv": 0.005,
        "publish_rate_hz": 30.0,
        "pose_stale_s": 0.05,
        "twist_stale_s": 0.02,
        "pose_only_grace_s": 0.05,
        "lost_after_gap_s": 0.25,
        "recovery_good_samples": 1,
        "consistency_samples": 3,
        "consistency_spread_max_m": 0.1,
        "deadband_m": 0.01,
        "jump_reject_m": 0.25,
